...
let model_33 = inventory[32].car_model;
let make_33 = inventory[32].car_make;
let year_33 = inventory[32].car_year;
console.log(`Car 33 is a ` + year_33 + " " + make_33 + " " + model_33);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory[49].car_make +" " + inventory[4].car_model;
console.log(lastCar);
